...
SECRET_KEY = 'django-insecure-%)^c)&m71+=gms+*)s7-99iq*wjy)m8q^ex55u=o6qdt@+h_gu'
...
CELERY_BROKER_URL = os.environ.get('CELERY_BROKER_URL', 'redis://redis:6379') #'redis://redis:6379'
